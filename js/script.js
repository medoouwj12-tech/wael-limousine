...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      'services.s7.title': 'خدمة رجل العمال',
      'services.s7.desc': 'دورات نقل يومية للموظفين للشركات والمصانع والبنوك والجامعات والمعاهد والمدارس.',
      'services.s8.title': 'سفر واستقبال جميع المطارات',
      'services.s8.desc': 'استقبال وتوديع في جميع المطارات المصرية مع خدمة الاستقبال والمساعدة.',
      'services.s9.title': 'توصيل جميع محافظات مصر',
      'services.s9.desc': 'توصيل من الباب للباب لجميع محافظات الجمهورية.',
      'services.s10.title': 'تنظيم ملفات سياحة داخلية',
      'services.s10.desc': 'تنظيم برامج سياحية داخلية متكاملة وحجز الفنادق والرحلات.',
      'services.s11.title': 'يوميات داخل القاهرة وخارجها للعرب',
      'services.s11.desc': 'رحلات يومية داخل القاهرة وخارجها للعملاء العرب.',
      'services.s12.title': 'عربيات يومية على خط القاهرة إسكندرية',
      'services.s12.desc': 'سيارات يومية على خط القاهرة الإسكندرية الساحل مطروح السلوم سيوة الغردقة.',
      'services.s13.title': 'عروض يومية على خط القاهرة إسكندرية',
      'services.s13.desc': 'عروض خاصة يومية على خط القاهرة الإسكندرية الساحل مطروح السلوم سيوة الغردقة.',
    ...
    en: {
      ...
      'services.s7.title': 'Employee Transport',
      'services.s7.desc': 'Daily staff transport for companies, factories, banks, universities, institutes, and schools.',
      'services.s8.title': 'All Airport Transfers',
      'services.s8.desc': 'Meet & greet service at all Egyptian airports for arrivals and departures.',
      'services.s9.title': 'Nationwide Delivery',
      'services.s9.desc': 'Door-to-door transport to all Egyptian governorates.',
      'services.s10.title': 'Domestic Tourism Packages',
      'services.s10.desc': 'Full organization of domestic tourism programs including hotels and trips.',
      'services.s11.title': 'Daily Cairo Trips for Arab Clients',
      'services.s11.desc': 'Daily excursions within and outside Cairo for Arab travelers.',
      'services.s12.title': 'Daily Cairo-Alexandria Route',
      'services.s12.desc': 'Daily cars on Cairo-Alexandria, North Coast, Matrouh, Sallum, Siwa, Hurghada routes.',
      'services.s13.title': 'Daily Route Offers',
      'services.s13.desc': 'Special daily offers on Cairo-Alexandria, North Coast, Matrouh, Sallum, Siwa, Hurghada routes.',
