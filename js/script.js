...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      'about.p1': 'بدأت وائل ليموزين من أكتر من 10 سنين بعربية مرسيدس واحدة ووعد بسيط: نقدّم تجربة سائق خاص تليق بالاسم. دلوقتي، أسطولنا كبر لـ 9 سيارات فاخرة — لكن الوعد ما اتغيرش.',
    ...
    en: {
      ...
      'about.p1': "Wael Limousine began over a decade ago with a single Mercedes and a simple promise: deliver a chauffeur experience worthy of the name. Today, our fleet has grown to nine premium vehicles — but the promise hasn't changed.",
